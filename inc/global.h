...
extern char TRIVIAL_ENCODING_FILE[FILENAME_LENGTH], CONSTRAINTS_FILE[FILENAME_LENGTH], TMP_FILE[FILENAME_LENGTH], SCRIPT_PATH[FILENAME_LENGTH], BOOL_PATH[FILENAME_LENGTH];
