...
extern boolean unfix, verbose, DC,decode_flag, SET,ABCFLAG, *DC_custom, CPOG_SIZE, DISABLE_FUNCTION, OLD, mod_bit_flag, VER;
extern char *ESPRESSO_PATH, *ABC_PATH, *LIBRARY_FILE, CURRENT_PATH[stringLimit], *FOLDER_NAME, *VERILOG_FILE;

extern char TRIVIAL_ENCODING_FILE[FILENAME_LENGTH], CONSTRAINTS_FILE[FILENAME_LENGTH], TMP_FILE[FILENAME_LENGTH], SCRIPT_PATH[FILENAME_LENGTH], BOOL_PATH[FILENAME_LENGTH], TMP_NAME[FILENAME_LENGTH];
